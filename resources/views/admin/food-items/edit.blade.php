                                ...
                                <div class="card-body">
                                    <form action="#" id="basicform" data-parsley-validate="" novalidate="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="inputItemImageUrl" type="text" name="image_url" data-parsley-trigger="change" required="" placeholder="http://www.billys.com/img/burgers.jpeg" autocomplete="off" class="form-control">
                                        </div>
